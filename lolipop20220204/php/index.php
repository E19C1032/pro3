...
<head>
    ...
    <link rel="stylesheet" href="css/master.css?202201161602">
...
<body>
                    ...
                    <div id="cotainer-latest-articles">
                        ...
                        <div class="article">
                            ...
                            <div class="article-info">
                                ...
                                <p class="name"><label><?php echo $lar[$i]["name"] ?></label></p>
                    ...
                    <div class="articles">
                        ...
                        <div class="article">
                            ...
                            <div class="article-info">
                                ...
                                <p class="head-name">聖地名</p>
                                <p class="name"><label><?php echo $far["name"] ?></label></p>
                                <p class="head-title">作品名</p>
                                <p class="title"><span><?php echo $wr["title"] ?></span></p>
                            </div>
                        </div>
            ...
            <div id="popular-title">
                <ol>
                    ...
                    <li>
                        <div></div>
                        <a
                            href="article.php?wid=<?php echo $result["workID"] ?>"><label><ruby><?php echo $result["title"] . "<rt>" . $result["titlePseudonym"] . "</rt></ruby>"?></label></a>
    ...
    <script src="js/map.js?202201092000"></script>
