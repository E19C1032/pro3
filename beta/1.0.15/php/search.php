...
<head>
    ...
    <script src="js/search.js?202111221630"></script>
</head>
            ...
            <main>
                <div id="main-container">
                    <div id="container-search">
                        <div id="main">
                            <input type="text" id="input-search" placeholder="検索"><br>
                            ...
                            <a href="article.php?wid=<?php echo $workID ?>" class="title"
                                data-type="<?php echo $type ?>"><?php echo $title . "（" . $titlePseudonym . "）（" . $typeStr[$type] . "）" ?></a><br>
                        ...
                        <div id="aside">
                                ...
                                <ol>
                                    ...
                                    <li>
                                        <a href="article.php?wid=<?php echo $result["workID"] ?>"
                                            data-type="<?php echo $result["type"] ?>"><?php echo $result["title"] . "（" . $result["titlePseudonym"] . "）（" . $typeStr[$result["type"]] . "）" ?></a>
                                    </li>
                            ...
                            <div id="lr">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a
                                            href="view.php?v=<?php echo $lr[$i]["articleID"] ?>"><?php echo $lr[$i]["name"] ?></a>
                                    </li>
                            ...
                            <div id="fr">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a
                                            href="view.php?v=<?php echo $result["articleID"] ?>"><?php echo $result["name"] ?></a>
                                    </li>
