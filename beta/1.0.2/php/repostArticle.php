...
<html lang="ja" dir="ltr">
    <head>
        ...
        <script src="js/postArticle.js?202110191406"></script>
    </head>
    <body>
        ...
        <div id="container">
            ...
            <main>
                ...
                <form action="updateArticle.php?aid=<?php echo($aid) ?>" method="POST" name="formPost" enctype="multipart/form-data">
                    ...
                    <label for="form-post-work-pseudonym">作品かな（必須）</label>
                    <input type="text" name="formPostWork" id="form-post-work-pseudonym" list="worklist">
                    ...
                    <img id="preview" src="<?php echo(readImageToBase64("image/" . $result["image"])) ?>" alt="">
