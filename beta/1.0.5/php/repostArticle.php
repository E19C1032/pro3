...
<head>
    ...
    <script src="js/postArticle.js?202110212238"></script>
</head>
        ...
        <main>
            ...
            <div id="draft-container">
                ...
                <ul>
                    ...
                    <li class="draft-item" data-id="<?php echo ($dr[$i]["draftID"]) ?>"><?php echo ($dr[$i]["name"]) ?>
                    </li>
            ...
            <form action="updateArticle.php?aid=<?php echo ($aid) ?>" method="POST" name="formPost"
                ...
                <table border="1">
                    <tr>
                        ...
                        <td><input type="text" name="formPostName" id="form-post-name"
                                value="<?php echo ($result["name"]) ?>">
                        </td>
                    </tr>
                    <tr>
                        <td><label for="form-post-work">作品名（必須）</label>
                        </td>
                        <td><input type="text" name="formPostWork" id="form-post-work" list="worklist"
                                value="<?php echo ($wr["title"]) ?>">
                        </td>
                    </tr>
                    <tr>
                        <td><label for="form-post-work-pseudonym">作品名かな（必須）</label>
                        </td>
                        <td><input type="text" name="formPostWorkPseudonym" id="form-post-work-pseudonym"
                    ...
                    <datalist id="worklist">
                        ...
                        <option value="<?php echo ($r["title"] . "（" . $r["titlePseudonym"] . "）") ?>"
                    ...
                    <tr>
                        <td><label for="">写真選択（任意）</label>
                        </td>
                        <td><input type="file" accept="image/png, image/jpeg" name="formPostImage"
