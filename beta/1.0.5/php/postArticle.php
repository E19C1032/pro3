...
<head>
    ...
    <script src="js/postArticle.js?202110212342"></script>
</head>
        ...
        <main>
            ...
            <form action="addArticle.php" method="POST" name="formPost" enctype="multipart/form-data">
                <table border="1">
                    ...
                    <tr>
                        <td><label for="form-post-work-pseudonym">作品名かな（必須）</label></td>
                        <td><input type="text" name="formPostWorkPseudonym" id="form-post-work-pseudonym"></td>
                    </tr>
