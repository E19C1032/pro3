...
<head>
    ...
    <script src="js/view.js?202110212147"></script>
</head>
            ...
            <div id="main-container">
                ...
                <div id="container-info">
                    ...
                    <div id="button-container">
                        <button id="button-go" data-push="<?php if ($uaar) echo ("true");
                                                                    else echo ("false"); ?>">行きたい
                            <?php echo ($result["go"]) ?></button>
                        <button id="button-favorite" data-push="<?php if ($far) echo ("true");
                                                                        else echo ("false"); ?>">お気に入り</button>
