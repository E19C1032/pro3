...
<head>
    ...
    <script src="js/mypage.js?202110221805"></script>
</head>
                            ...
                            <div class="article">
                                ...
                                <div>
                                    ...
                                    <div class="article-footer">
                                        ...
                                        <button class="button-remove" data-aid="<?php echo $ar[$i]["articleID"] ?>">削除</button>
                                        <button class="button-edit" data-aid="<?php echo $ar[$i]["articleID"] ?>">編集</button>
                                    </div>
                                </div>
                            </div>
