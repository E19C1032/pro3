...
<html lang="ja" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="css/postArticle.css?202107162300">

        <script src="https://cdn.jsdelivr.net/npm/fetch-jsonp@1.1.3/build/fetch-jsonp.min.js"></script>
        <script src="js/data.js"></script>
        <script src="js/checkBlank.js"></script>
        <script src="js/postArticle.js?202107162302"></script>
    </head>
    <body>
        ...
        <main>
            ...
            <!-- 投稿フォーム -->
            <form action="add_article.php" method="POST" name="formPost" enctype="multipart/form-data">
                <label for="form-post-name">聖地名（必須）</label><br>
                <input type="text" name="formPostName" id="form-post-name"><br>

                <label for="form-post-work">作品名（必須）</label><br>
                <input type="text" name="formPostWork" id="form-post-work" list="worklist"><br>
                <!-- タイトルの候補リスト -->
                ...
                <fieldset>
                    ...
                    <input type="text" name="formPostMunicipality" id="form-post-municipality" size="50"><br>
                ...
                <textarea name="formPostDetails" id="" cols="50" rows="10" placeholder="特記事項や行った時の注意点など"></textarea><br>
