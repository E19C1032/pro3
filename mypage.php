...
<html lang="ja" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="css/mypage.css?202107161552">
        ...
        <main>
            ...
            <div id="main-container">
                    ...
                    <div id="article-container">
                        ...
                        <div class="article" data-aid="<?php echo($ar[$i]["articleID"]) ?>">
                            ...
                            <div class="article-footer">
                                ...
                                <span class="article-delete">削除</span>
                ...
                <div id="menu-container">
                    ...
                    <ul>
                        <li><a href="post_article.php">投稿</a></li>
                        <li><a href="#">お気に入り記事一覧</a></li>
                        <li><a href="latest_article.php">最新記事一覧</a></li>
                        <li><a href="#">詳細検索</a></li>
