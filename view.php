...
<html lang="ja" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="css/view.css?202107161541">
            ...
            <div id="main-container">
                ...
                <div id="container-info">
                    ...
                    <div id="button-container">
                        ...
                        <button id="button-report">通報</button>
                    </div>
                </div>
                ...
                <div id="post-comment-container">
                    <form action="post_comment.php?aid=<?php echo($result["articleID"]) ?>" method="POST" name="formComment" enctype="multipart/form-data">
