...
// 利用規約ファイル読み込み
$termsOfUse = file_get_contents("./text_contents/terms_of_use.txt");
...
<html lang="ja" dir="ltr">
    ...
    <body>
        ...
        <main>
            ...
            <form action="add_user.php" method="POST" name="formCreateAccount">
                <fieldset>
                    ...
                    <h2>利用規約</h2>
                    <textarea name="" id="" cols="30" rows="10" value="aaa" disabled><?php echo($termsOfUse) ?></textarea><br>
                    <input type="checkbox" name="consent" id="input-consent"><label for="input-consent">利用規約に同意する</label><br>
